...
class ColorConfig:
    def __init__(self):
        # Matplotlib用にHEXコードで定義
        self.palette = {
            'navy': '#002060', 
            'red': '#E60000', 
            'teal': '#008080',
            'gray_text': '#595959', 
            'gray_bg': '#F2F2F2', # ここもHEXに統一
            'white': '#FFFFFF', 
            'black': '#000000'
        }
...
class FontConfig:
    def __init__(self):
        ...
        # 'Meiryo UI' だとMatplotlibが認識しないことがあるため 'Meiryo' または 'MS Gothic' 推奨
...
# ==============================================================================
# B. グラフ描画戦略クラス (Matplotlib Version)
# ==============================================================================
class ChartStrategies:
    def __init__(self, config: SlideConfig):
        ...
        # 【重要】sns.set_themeするとフォント設定がリセットされるため、ここで再適用する
        # これで文字化けが直ります
    ...
    def plot_combo_bar_line_2axis(self, df, mapping, chart_text):
        print(f"  [DEBUG] Matplotlibで複合グラフを描画します。")
